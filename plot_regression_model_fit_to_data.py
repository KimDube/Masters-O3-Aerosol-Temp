...
if __name__ == "__main__":
    ...
    s_03to08 = np.zeros(len(alts))  # solar coeff. multi. reg.
    t_03to08 = np.zeros(len(alts))  # temp. coeff. multi. reg.
    int_03to08 = np.zeros(len(alts))  # y-int. multi. reg.

    C_03to08 = np.zeros(len(alts))  # solar coeff. single reg.
    sint_03to08 = np.zeros(len(alts))  # y-int. single reg.
    ...
    for i in range(16, 17):
        ...
        colours = ['red', 'bright sky blue', 'blue']
