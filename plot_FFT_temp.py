...
if __name__ == "__main__":
    ...
    data_02to15 = np.load('/home/kimberlee/Masters/npyvars/temperature_02to15_trop_filtered.npy')
    data_03to08 = np.load('/home/kimberlee/Masters/npyvars/temperature_03to08_trop_filtered.npy')
    data_09to15 = np.load('/home/kimberlee/Masters/npyvars/temperature_09to15_trop_filtered.npy')
    ...
    ax1.plot(per_02to15_50[100:1000], 1000 * pow_02to15_50[1, 100:1000], linewidth=2,
             label="2002-2015")
    ax1.plot(per_03to08_50[50:1000], 1000 * pow_03to08_50[1, 50:1000], linewidth=2,
             label="2003-2008")
    ax1.plot(per_09to15_50[50:1000], 1000 * pow_09to15_50[1, 50:1000], linewidth=2,
             label="2009-2015")
    ax1.legend(bbox_to_anchor=(0., 1.02, 1., .102), loc=3,
               ncol=3, mode="expand", borderaxespad=0.)
    ax1.text(10.5, 0.7, '%.1f km' % alts[31])

    ax2.plot(per_02to15_45[100:1000], 1000 * pow_02to15_45[1, 100:1000], linewidth=2)
    ax2.plot(per_03to08_45[50:1000], 1000 * pow_03to08_45[1, 50:1000], linewidth=2)
    ax2.plot(per_09to15_45[50:1000], 1000 * pow_09to15_45[1, 50:1000], linewidth=2)
    ax2.text(10.5, 0.7, '%.1f km' % alts[26])

    ax3.plot(per_02to15_40[100:1000], 1000 * pow_02to15_40[1, 100:1000], linewidth=2)
    ax3.plot(per_03to08_40[50:1000], 1000 * pow_03to08_40[1, 50:1000], linewidth=2)
    ax3.plot(per_09to15_40[50:1000], 1000 * pow_09to15_40[1, 50:1000], linewidth=2)
    ax3.text(10.5, 0.7, '%.1f km' % alts[21])

    ax4.plot(per_02to15_35[100:1000], 1000 * pow_02to15_35[1, 100:1000], linewidth=2)
    ax4.plot(per_03to08_35[50:1000], 1000 * pow_03to08_35[1, 50:1000], linewidth=2)
    ax4.plot(per_09to15_35[50:1000], 1000 * pow_09to15_35[1, 50:1000], linewidth=2)
    ax4.text(10.5, 0.7, '%.1f km' % alts[16])

    ax5.plot(per_02to15_30[100:1000], 1000 * pow_02to15_30[1, 100:1000], linewidth=2)
    ax5.plot(per_03to08_30[50:1000], 1000 * pow_03to08_30[1, 50:1000], linewidth=2)
    ax5.plot(per_09to15_30[50:1000], 1000 * pow_09to15_30[1, 50:1000], linewidth=2)
    ax5.text(10.5, 0.7, '%.1f km' % alts[11])
    ax5.set_xlabel("Period [days]")

    f.text(0.005, 0.5, "Signal Power * 1000", va='center', rotation='vertical')
    plt.xlim([10, 35])
    plt.ylim([0, 1])
    ...
    plt.savefig("/home/kimberlee/Masters/Thesis/Figures/fft_temp_lineplts.png", format='png', dpi=300)
    plt.show()
